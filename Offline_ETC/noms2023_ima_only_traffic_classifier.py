...
class NOMS2023InstantMessagingClassifier(EncryptedTrafficClassifier):
    def __init__(self, nb_folds, nb_packets_per_flow):        
        super().__init__(
            ...
            filename_prefix = "noms2023_ima_only",
            processed_data_output_dir = "noms2023_ima_only_output/",
            # processed_data_output_dir = "noms2023_ima_only_output_addendum/",
            data_dir = "data/noms2023_ima_only/"            
        )
...
if __name__ == "__main__":
    ...
    if VISUALIZATION_ENABLED:
        ...
        # classifier._size_std_max_class_distribution(_df, classifier.filename_prefix + "_flows_std_max_size_distribution_" + str(pkt) + '_pkt', xylog= True)
        # classifier._max_size_distribution(_df, classifier.filename_prefix + "_flows_max_size_distribution_" + str(pkt) + '_pkt')
        sys.exit(1)
    ...
    if RF_ENABLED:
        ...
        print("classifier.X_test_flows =", classifier.X_test_flows[(8,0)].shape)
        print("classifier.y_test_flows =", classifier.y_test_flows[(8,0)].shape)
        print("classifier.y_test_isolated_flows =", classifier.y_test_isolated_flows.shape)
        print("rf_y_test_flows_isolated_predicteds[(8,0)] =", rf_y_test_flows_isolated_predicted[(8,0)].shape)
        rf_F1 = {}
        skl_F1 = {}
